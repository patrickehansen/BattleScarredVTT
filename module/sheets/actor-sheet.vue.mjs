...
export class v3boilerplateActorSheetVue extends v3boilerplateActorSheet {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      ...
      template: "systems/vueBattleScarred/templates/actor/actor-sheet.vue.html",
      width: 600,
      height: 600,
  ...
  /** @override */
  get template() {
    return `systems/vueBattleScarred/templates/actor/actor-${this.actor.type}-sheet.vue.html`;
  }
  ...
  getData() {
    ...
    console.log('hey heres our getData', context);
    return context;
  }
  ...
  render(force=false, options={}) {
    ...
    if (!this.vueApp) {
      this.vueApp = createApp({
        data() {
          console.log('this is the render', context);
          return {
            context: context,
          }
        },
